import { Artifact, ArtifactMapper, withConstructorInput, withCustomConstructorInputName } from "../../src"
...
const tests: Test[] = [
    {
        ...
        mapper: withConstructorInput("pubKey", Buffer.from("c6d0c728b8e8fd24cf1a6022578f73820ba22e44fbc6de3a4b1a8b7f397fdbd1", 'hex')),
        expected: {
            ...transferWithKey,
            constructorInputs: [],
            functions: [
